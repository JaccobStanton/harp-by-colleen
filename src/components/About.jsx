...
export default function About({
  ...
  copy = `Colleen is a professional harpist in St. Louis, MO.  She proudly served as principal harpist with the STL Philharmonic Orchestra and has performed with a wide array of esteemed ensembles including the St. Louis Symphony, Union Avenue Opera, Winter Opera, the St. Louis Bach Society, Metropolitan Orchestra of St. Louis, among many others.`,
    ...
    >
      <Container disableGutters sx={{ px: { xs: 2, sm: 3, md: 4, lg: 6 } }}>
        ...
        >
          ...
          {/* Right panel (centered content + staggered fade) */}
          <Paper
            elevation={0}
            sx={{
              ...
              border: "1px solid",
              borderColor: "divider",
              borderLeft: "none", // no seam between the two on md+
